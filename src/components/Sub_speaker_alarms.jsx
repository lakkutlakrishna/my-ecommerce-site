...
// import '../styles/Sub_speaker_alarms.css';

// const Sub_speaker_alarms = () => {
...
//   return (
//     <div className="Sub_speaker_alarms-container">
//       {/* Header */}
//       <h1 className="Sub_speaker_alarms-header">Alarms</h1>
...
//       <div className="Sub_speaker_alarms-grid-sort-options">
//         <div className="Sub_speaker_alarms-grid-buttons">
//           <span>Grid View:</span>
//           {[2, 3, 4, 5].map((columns) => (
//             <button
//               key={columns}
//               className={`Sub_speaker_alarms-grid-view-button ${activeButton === columns ? 'Sub_speaker_alarms-button-active' : ''}`}
...
//           ))}
//           <button
//             className="Sub_speaker_alarms-grid-view-button"
//             onClick={toggleTableView}
//           >
//             <i className="fas fa-th"></i>
//           </button>
//         </div>
//         <div className="Sub_speaker_alarms-sort-options">
//           <div>
//             <label>Sort By:</label>
//             <select className="Sub_speaker_alarms-sort-select">
...
//             </select>
//           </div>
//           <button className="Sub_speaker_alarms-compare-button">
//             Product Compare (0)
//           </button>
//         </div>
//       </div>
...
//       {/* Product List */}
//       {isTableView ? (
//         <table className="Sub_speaker_alarms-table">
//           <thead>
//             <tr>
//               <th>Image</th>
//               <th>Price</th>
...
//                     src={item.image}
//                     alt={item.title}
//                     className="Sub_speaker_alarms-table-image"
//                   />
//                 </td>
//                 <td>{item.price}</td>
...
//                 <td>{item.title}</td>
//                 <td>
//                   <div className="Sub_speaker_alarms-table-actions">
//                     <button className="Sub_speaker_alarms-action-button">
...
//         </table>
//       ) : (
//         <div className={`Sub_speaker_alarms-grid Sub_speaker_alarms-grid-cols-${gridColumns}`}>
//           {items.map((item) => (
//             <div key={item.id} className="Sub_speaker_alarms-product-card">
//               <div className="Sub_speaker_alarms-product-image">
//                 <img
//                   src={item.image}
//                   alt={item.title}
//                   className="Sub_speaker_alarms-image"
//                 />
//                 <div className="Sub_speaker_alarms-overlay">
//                   <button className="Sub_speaker_alarms-overlay-button">
//                     <i className="fas fa-search"></i>
//                   </button>
//                 </div>
//               </div>
//               <h2 className="Sub_speaker_alarms-product-title">{item.title}</h2>
//               <div className="Sub_speaker_alarms-rating">
//                 {Array.from({ length: 5 }).map((_, i) => (
//                   <span key={i} className="Sub_speaker_alarms-star">
//                     <i className="fas fa-star"></i>
//                   </span>
//                 ))}
//                 <span className="Sub_speaker_alarms-rating-count">(8)</span>
//               </div>
//               <p className="Sub_speaker_alarms-price">{item.price}</p>
//               <div className="Sub_speaker_alarms-actions">
//                 <button className="Sub_speaker_alarms-action-button">
//                   <i className="fas fa-heart"></i>
//                 </button>
//                 <button className="Sub_speaker_alarms-action-button">
...
// export default Sub_speaker_alarms;
...
//       ]);
  ...
  return (
    <div className="Sub_speaker_alarms-container">
      ...
      {/* Product List */}
      {items.length === 0 ? (
        <div className="Sub_speaker_alarms-no-products">
          <p>There are no products to list in this category.</p>
          <a href='/'><button className="Sub_speaker_alarms-continue-button">Continue</button></a>
        </div>
      ) : isTableView ? (
        <table className="Sub_speaker_alarms-table">
          <thead>
